...
<body>
  ...
  <div class="page">
    ...
    <main>
      ...
      <p class="bio">
        Welcome travelers! I am a Ph.D. Candidate in Economics at Howard University in Washington, D.C.
        My research sits at the intersection of labor and urban economics , with a focus on the economic role of Historically Black
        Colleges and Universities (HBCUs) racial wage disparities and unionization, and I use large scale datasets and econometric methods
      ...
      <div class="section">
        ...
        <ul class="bullet-list">
          ...
          <li>Academic tutoring and instruction (3+ years)</li>
        </ul>
      </div>
</main>
  </div>
